...
INTEGER(4) :: nlateral(nlayer),nelem(nlayer),iload
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   IF(ID.EQ.0) THEN
    call get_reac(mesh0,forces,BCs%nCodeLoad,ylength, & 
              BCs%mdofBC,BCs%ndofBC,reaction1,reaction2,x0,BCs,iload)
   ENDIF
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 ...
 !     open(unit=79,file='energyreal.dat',status='old',position='append')   ! energy output file
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   !      write(79,'(4f17.9)') BCs%value*iload/BCs%nloadstep,E_out(1), E_out(2), E_out(3),vdw1%Wbondtot   
         close(50)
   !      close(79)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
